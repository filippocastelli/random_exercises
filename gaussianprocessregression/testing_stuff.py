...
theta0 = {'const': 1.0, 'period': 5.0, 'length': 5.0}
if optim == True:
    params= gaus2.grad_optimizer(theta0)
...
create_case(x, x_guess, y,
            kernel= GPR.generate_kernel(GPR.kernel_periodic, const = pms[0] , period =pms[1], length= pms[2]),
            R= pms[3],
