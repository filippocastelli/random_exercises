...
def gen_graph(target_db, source_db):
...
def nodelist(kegg_graph, nodetype):
...
#%%
KEGG = gen_graph("disease", "hsa")

genes = nodelist(KEGG, "hsa")
diseases = nodelist(KEGG, "disease")
#%%
gene_net = projected_graph(KEGG,genes)
disease_net = projected_graph(KEGG, diseases)

subgraphs = list_subgraphs(disease_net)